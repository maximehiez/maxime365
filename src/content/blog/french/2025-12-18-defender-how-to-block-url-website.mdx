---
title: "Comment bloquer une URL de site web dans Edge avec Defender"
meta_title: ""
description: ""
...
author: "Maxime Hiez"
tags: ["EDR", "Sécurité", "URL", "Edge", "Smartscreen"]
draft: false
---
---
...
Dans l'article du mois dernier [ICI](https://maxime.hiez.ca/blog/2025-11-27-purview-how-to-enable-dspm-for-ai), on pouvait voir à travers la console *Purview DSPM for AI* que des connexions vers le site d'IA *Deepseek* ont été effectuées, et il serait préférable qu'il soit bloqué pour des mesures de sécurité.
...
<Notice type="note">La règle peut prendre jusqu'à 48 heures avant d'être effective, mais a pris quelques heures pour moi.</Notice>
...
<Notice type="note">En ayant confiuguré l'attribut *User notification custom URL*, si l'utilisateur clique sur *Visit the support page*, il sera redirigé vers cet URL.</Notice>
...
##### Conclusion
Vous savez maintenant comment bloquer des URL de sites web dans Microsoft Edge via Defender.
