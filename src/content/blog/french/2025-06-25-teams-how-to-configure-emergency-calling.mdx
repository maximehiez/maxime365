...
author: "Maxime Hiez"
tags: ["Téléphonie", "Direct Routing", "Syslog", "SBC", "Appel d'urgence", "911", "PowerShell"]
draft: false
---
---
...
<Notice type="note">Si vos sous-réseaux se chevauchent sur plusieurs sites, la localisation ne pourra pas fonctionner. La solution est de les remplacer par les adresses mac des switchs / BSSID des bornes WiFi.</Notice>
