...
J'avais déjà couvert comment faire l'installation du certificat *DigiCert Global Root G2* dans [l'article de Janvier 2025](https://maxime.hiez.ca/blog/2025-01-21-audiocodes-how-to-import-certificate), vous pouvez vous y référer.
...
Dans le proxy *Teams*, ajoutez le proxy de test **sip.g1.pstnhub.microsoft.com:5061**.
