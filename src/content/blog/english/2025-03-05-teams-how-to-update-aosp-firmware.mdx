...
##### Introduction
I wrote an article last February on how to prepare the migration of your Android-based Microsoft Teams devices to *AOSP* (*Android Open Source Project*). The firmware has just been released for Poly devices, so here is how to update.

Check the article from February 2025 [HERE](https://maxime.hiez.ca/en/blog/2025-02-09-intune-how-to-migrate-aosp-teams-phones).
...
<Notice type="info">This step will take a few minutes. The phone will reboot, unenroll from Intune, and re-enroll.</Notice>
