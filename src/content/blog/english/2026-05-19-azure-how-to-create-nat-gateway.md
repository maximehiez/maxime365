...
##### Introduction
I told you last March about the end of implicit Internet access for new *Virtual Networks* (*VNets*) in Azure and the need to configure an explicit Internet exit solution (*Azure NAT Gateway*, firewall, or load balancer with egress rules).
