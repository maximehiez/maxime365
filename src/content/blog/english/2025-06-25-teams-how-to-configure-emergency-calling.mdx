...
<Notice type="tip">If your subnets overlap across multiple sites, location tracking won't work. The solution is to replace them with the MAC addresses of the switches / BSSIDs of the WiFi hotspots.</Notice>
