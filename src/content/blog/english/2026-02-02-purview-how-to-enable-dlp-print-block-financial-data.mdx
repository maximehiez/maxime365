...
##### Introduction
A few weeks ago, I showed you how to enable DLP to prevent the copying of financial data to an external cloud storage solution using *Microsoft Purview*, in order to prevent accidental or malicious data leaks (*Data Loss Prevention*). Continuing with the idea of talking to you about DLP, here this time is how to protect the printing of financial data.
...
You now know how to enable DLP for printing with Purview.
