...
##### Introduction
I wrote an article last February to announce the upcoming release of the SIP ladder to analyze Teams Direct Routing calls from the Microsoft Teams Admin Center. The feature is now available.
...
<Notice type="info">Data will be available for all calls less than 30 days old, with a 30-minute delay before analysis is available.</Notice>

---

##### Conclusion
The SIP ladder for analyzing Teams Direct Routing calls from the Microsoft Teams Admin Center will simplify analytics for Teams telephony administrators.<br/><br/>
You now know how to access SIP ladder for Teams call analysis.
